 ...
 const allServices = [
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      function showDefaultHome() {
        defaultHomeContent.style.display = "block";
        mergedSearchSection.style.display = "none";
      ...
      function showSearchResults(rawQuery) {
        ...
        defaultHomeContent.style.display = "none";
        mergedSearchSection.style.display = "block";

        searchTitle.textContent = "Search Results";
        searchSubtitle.textContent = `Found ${filteredResults.length} result(s) for "${rawQuery}"`;
        ...
        if (filteredResults.length > 0) {
          ...
          failedKeywordSpan.textContent = rawQuery;
        }
      }
